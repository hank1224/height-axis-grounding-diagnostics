...
def process_attempt(
    *,
    ...
    attempt_record = {
        ...
        "top_view_result_type": comparison["top_view_result_type"],
        ...
        while True:
            ...
            try:
                ...
                print(
                    ...
                    f"top_view_match={attempt_record['top_view_slot_match']} "
    ...
    attempts_csv_rows = [
        {
            ...
            "top_view_result_type": item["top_view_result_type"],
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run top-view localization benchmarks."
    )
...
def main() -> int:
    ...
    except (BenchmarkError, JsonParseError, TopViewSchemaError, ProviderError, ApiErrorGuardError, ValueError) as exc:
