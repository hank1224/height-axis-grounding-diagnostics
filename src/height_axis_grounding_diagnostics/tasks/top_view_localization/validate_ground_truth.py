...
from height_axis_grounding_diagnostics.tasks.top_view_localization.schema import validate_ground_truth_payload  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Validate top-view localization ground truth."
    )
    parser.add_argument(
        "ground_truth",
        nargs="?",
    ...
    parser.add_argument(
        ...
        help="Top-view localization cases JSON.",
    )
    parser.add_argument(
        "--require-complete",
        action="store_true",
...
def main() -> int:
    ...
    print(
        f"Validation passed for {answer_count} top-view localization answer groups "
