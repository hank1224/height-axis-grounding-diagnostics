...
from height_axis_grounding_diagnostics.tasks.pcb_face_axis_mapping.schema import validate_ground_truth_payload  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Validate PCB face axis mapping ground truth."
    )
    parser.add_argument(
        "ground_truth",
        nargs="?",
    ...
    parser.add_argument(
        ...
        help="PCB face axis mapping cases JSON.",
    )
    parser.add_argument(
        "--require-complete",
        action="store_true",
...
def main() -> int:
    ...
    print(
        f"Validation passed for {answer_count} PCB face axis mapping answer groups "
